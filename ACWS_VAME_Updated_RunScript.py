...
working_directory = '/d1/studies/VAME'
project='OptoSideProfile'
videos = ['/d1/studies/VAME/VAME_20FPS_SIDEVIEWMODEL/videos/']
...
vame.egocentric_alignment(config, pose_ref_index=[0,1,2,3,4,5,6,7,8])
