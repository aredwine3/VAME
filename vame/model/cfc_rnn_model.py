...
class Encoder(nn.Module):
    ...
    def __init__(self, NUM_FEATURES, hidden_size_layer_1, hidden_size_layer_2, dropout_encoder):
        ...
        self.wiring = AutoNCP(NUM_FEATURES, int(NUM_FEATURES*0.3))
        ...
        self.encoder_cfc_rnn = CfC(
            input_size=self.wiring, 
            ...
            mode = "default",
            activation = "relu",
            backbone_units = self.hidden_size,
            backbone_layers = self.n_layers,
            backbone_dropout = self.dropout,
            )
    ...
    def forward(self, inputs):        
        ...
        outputs_2, hidden_2 = self.encoder_cfc_rnn(inputs)
        ...
        hidden = torch.cat((hidden_2[0,...], hidden_2[1,...], hidden_2[2,...], hidden_2[3,...]),1)
...
class Decoder(nn.Module):
    ...
    def forward(self, inputs, z):
        ...
        decoder_output, _ = self.cfc_rnn_rec(inputs, hidden)
...
class Decoder_Future(nn.Module):
    ...
    def forward(self, inputs, z):
        ...
        decoder_output, _ = self.cfc_rnn_pred(inputs, hidden)
